function compile_matmul(){
  rm matmul_v3/*.o
  rm matmul_v3/kernel/*.o
  sed -i "37c\(dim1, dim2, dim3) = (${1}, ${2}, ${3})" matmul_v3/script/gen_data.py
  make bin/matmul_v3 config=${4}_lanes
  mv bin/matmul_v3 bin/matmul_${1}x${2}x${3}_${4}_lanes
  mv bin/matmul_v3.dump bin/matmul_${1}x${2}x${3}_${4}_lanes.dump
}
