...
void matmul_biased(float *mat_a, float *mat_b, float *o, float *bias, int dim1,
                   int dim2, int dim3, int transposed);

// scale the matmul result
void matmul_scaled(float *mat_a, float *mat_b, float *o, float scale, int dim1,
                   int dim2, int dim3, int transposed);
